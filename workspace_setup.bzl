...
def hedron_make_cc_https_easy():
    ...
    maybe(
        ...
        url = "https://github.com/hedronvision/bazel-cc-filesystem-backport/archive/1af7641e3f13f90da54b63ea704d6e96bfde8478.tar.gz",
        sha256 = "4a79d5727616e9d0fe9cc582774d12816876a663dbbda3d40ad30c01f1605ef2",
        strip_prefix = "bazel-cc-filesystem-backport-1af7641e3f13f90da54b63ea704d6e96bfde8478",
    )
    ...
    maybe(
        http_archive,
        name = "boringssl",
        url = "https://github.com/hedronvision/boringssl/archive/3898798232ea270aa45b3fe3d421f5465afcccca.tar.gz",
        sha256 = "cc609be45a14bb955cb80977e830ee661f34276be0a0cc71209cf4bf5c8dea98",
        strip_prefix = "boringssl-3898798232ea270aa45b3fe3d421f5465afcccca",
    )
