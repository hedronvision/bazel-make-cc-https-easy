...
def hedron_make_cc_https_easy():
    ...
    maybe(
        ...
        url = "https://github.com/nelhage/rules_boost/archive/33aab092283315901a9e58d8bfaaee1e3f516a99.tar.gz",
        sha256 = "1f84c2a006d98de7635e3d9e491175869af0ea10681f50c42bd8b06a216d9d23",
        strip_prefix = "rules_boost-33aab092283315901a9e58d8bfaaee1e3f516a99",
    )
    boost_deps()
    ...
    maybe(
        http_archive,
        name = "boringssl",
        url = "https://github.com/hedronvision/boringssl/archive/2666bf9e0417d0f66cfa702a00325bc6cb2779d1.tar.gz",
        sha256 = "b9cb70fdd03742da74e74e42e986100ea2d2558355fea8323de69e509a56d674",
        strip_prefix = "boringssl-2666bf9e0417d0f66cfa702a00325bc6cb2779d1",
    )
